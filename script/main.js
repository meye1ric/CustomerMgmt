...
function addCustomer() { // Create a new customer record in the Db.
	...
	if(customerFirstName == '' || customerFirstName == null || customerLastName == '' || customerLastName == null || customerAge == '' || customerAge == null || customerGender == '' || customerGender == null) {
		...
		$.ajax({
			type: "POST",
			url: "https://prod-00.centralus.logic.azure.com:443/workflows/f599662a07f749449c8b036924a09c61/triggers/manual/paths/invoke?api-version=2016-10-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=6ltm4qE0-cnsTe-mE1eQ6hFehilWKubYDr3ryMHtrSY",
			data: data,
...
function getCustomer(customerLastNameSearch, option) { // Retreive a customer record from the Db.
	...
	if(customerLastNameSearch == '' || customerLastNameSearch == null) {
		...
		if(option == "singleItemSearch") {
			var baseURL = "https://prod-20.centralus.logic.azure.com/workflows/45a425c8192440f39bfc75ac2e1c0300/triggers/manual/paths/invoke";
			var urlPath = "/lastName/";
			var urlPathParam = customerLastNameSearch;
			var urlQueryParam = "?api-version=2016-10-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=ncKBJtp0FvqfiDVOKznybKJmT2ZCSKGPkB85D6F17R4";
			var url = baseURL + urlPath + urlPathParam + urlQueryParam;
		} else {
			var url = "https://prod-30.centralus.logic.azure.com:443/workflows/c1fd86eca40c4ddcacfc476bb2d609ac/triggers/manual/paths/invoke?api-version=2016-10-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=la36qHuHec9n_ZHa84uYtKIZRGhqRFr-MpwkUCoa66o";
		}
...
function deleteCustomer(customerIdDelete) { // Delete a customer record in the Db.
	...
	if(customerIdDelete == '' || customerIdDelete == null) {
		...
		var baseURL = "https://prod-25.centralus.logic.azure.com/workflows/7decf7f245394318b511ca3130d5abd0/triggers/manual/paths/invoke";
		var urlPath = "/delete/";
		var urlPathParam = customerIdDelete;
		var urlQueryParam = "?api-version=2016-10-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=IP2Rv3QOgb_xQTfNlKY9zd1XzC4q3gDUnb-j9wqHmYE";
		var url = baseURL + urlPath + urlPathParam + urlQueryParam;
